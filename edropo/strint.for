...
c	yrrtmp2=0.0D0
	...
	Iopt=2
     ...
     +	  Qxxy1(j)*anrg(j))*w1(j)
c	  yxxtmp2=yxxtmp2+a*amg(j)*(Qxxx2(j)*anzg(j)+
c     +	  Qxxy2(j)*anrg(j))*w1(j)

	  yxrtmp1=yxrtmp1+a*amg(j)*(Qxyx1(j)*anzg(j)+
     +	  Qxyy1(j)*anrg(j))*w1(j)
c	  yxrtmp2=yxrtmp2+a*amg(j)*(Qxyx2(j)*anzg(j)+
c     +	  Qxyy2(j)*anrg(j))*w1(j)

	  yrxtmp1=yrxtmp1+a*amg(j)*(Qyxx1(j)*anzg(j)+
     +	  Qyxy1(j)*anrg(j))*w1(j)
c	  yrxtmp2=yrxtmp2+a*amg(j)*(Qyxx2(j)*anzg(j)+
c     +	  Qyxy2(j)*anrg(j))*w1(j)

	  yrrtmp1=yrrtmp1+a*amg(j)*(Qyyx1(j)*anzg(j)+
     +	  Qyyy1(j)*anrg(j))*w1(j)
c	  yrrtmp2=yrrtmp2+a*amg(j)*(Qyyx2(j)*anzg(j)+
c     +	  Qyyy2(j)*anrg(j))*w1(j)
      end do
